...
function paymentHandler($userId,$selectedPlan,$email){
  //echo " UserID= $userId , Plan = $selectedPlan ";
  $_SESSION['payers_id'] = $userId ;
  $_SESSION['payers_plan'] = $selectedPlan;
  $_SESSION['payers_email'] = $email ;
  //header("location:paymentRedirect.php");
...
<div class="jumbotron" >
  ...
  <form method="POST" enctype="multipart/form-data" name="myForm" id="myForm" action="" onsubmit="return oldValidate();">
